...
class GetActiveReservationUseCase @Inject constructor(private val reservationsRepository: ReservationsRepository) {

    operator fun invoke(): Flow<Resource<ReservationDomain?, ApiError>> {
        return reservationsRepository.getActiveReservation()
    }
}