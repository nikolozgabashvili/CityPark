package ge.tbca.city_park.auth.presentation
...
import ge.tbca.city_park.auth.presentation.screen.register.RegisterEffect
import ge.tbca.city_park.auth.presentation.screen.register.RegisterEvent
import ge.tbca.city_park.auth.presentation.screen.register.RegisterViewModel
...
class RegisterViewModelTest {
    ...
    fun setUp() {
        ...
        viewModel = RegisterViewModel(validateEmailUseCase, validatePasswordUseCase, signUpUseCase)
        coEvery { signUpUseCase(any(),any()) } returns flowOf(Resource.Success(Unit))
    }
